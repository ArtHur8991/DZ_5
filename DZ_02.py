...
import DZ_02_String_generator as dz2


PATH_ORIGINAL_STRING = "DZ_02_original_string.txt"
PATH_RLE_STRING = "DZ_02_RLE_string.txt"
PATH_DECOMPRESSED_STRING = "DZ_02_decompressed_string.txt"
TOP_DIVIDER = "-"*50+"\n"
BOTTOM_DIVIDER = "\n"+"-"*50
